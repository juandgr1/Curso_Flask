...
dbdir = "sqlite:///" + os.path.abspath(os.getcwd()) + "/Flask/Curso_Flask/12.message-flashing/database.db"
...
def home():
    if "username" in session:
        return "Your are %s" % escape(session["username"])
...
#esta clave es necesaria pra que funcionen las sesiones
